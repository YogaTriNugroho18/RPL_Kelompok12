<?php
$view = "SELECT foodcategory.category_id, foodcategory.category_name, menus.menu_id, menus.category_id, menus.menu_name, menus.menu_desc, menus.menu_price, menus.photo FROM foodcategory JOIN menus USING(category_id) WHERE category_id = '1'";
